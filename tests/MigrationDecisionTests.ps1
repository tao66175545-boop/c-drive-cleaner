...
$requiredSuites = @('ArchitectureContractTests.ps1', 'PlanContractTests.ps1', 'ProcessContractTests.ps1', 'ScanProviderTests.ps1', 'ExecutionBrokerTests.ps1', 'CopilotTests.ps1', 'AssistantToolTests.ps1', '.ui-smoke-test.ps1')
